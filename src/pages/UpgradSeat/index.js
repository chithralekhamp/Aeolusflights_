    ...
    <>
      <Stack className="bg-white_A700 font-nunitosans h-[900px] mx-[auto] relative w-[100%]">
        <Stack className="absolute bottom-[0] h-[2846px] w-[100%]">
          <Stack className="absolute h-[2846px] sm:pr-[15px] md:pr-[34px] pr-[66px] sm:py-[26px] md:py-[34px] py-[66px] right-[3%] sm:w-[100%] w-[97%]">
            <Row className="absolute flex flex-row md:flex-wrap sm:flex-wrap items-center justify-between left-[14%] sm:mx-[0] sm:px-[0] top-[35%] sm:w-[100%] w-[42%]">
              <Img
            ...
            <Stack className="absolute h-[2595px] sm:pb-[167px] md:pb-[216px] pb-[420px] sm:w-[100%] w-[92%]">
              <Column
          ...
          <Column className="absolute bg-white_A700_7f flex flex-col items-center justify-start sm:mx-[0] sm:w-[100%] w-[38%]">
                ...
                <Row className="bg-bluegray_900 flex flex-row md:flex-wrap sm:flex-wrap items-center justify-evenly w-[100%]">
                  <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-center justify-evenly sm:mx-[0] sm:px-[0] sm:w-[100%] w-[41%]">
                    <Column className="bg-bluegray_900 flex flex-col sm:mx-[0] sm:p-[15px] p-[19px] md:p-[9px] sm:w-[100%] w-[45%]">
                      <Text
                        className="font-extrabold sm:ml-[1px] md:ml-[2px] ml-[5px] mt-[1px] text-gray_51 uppercase w-[auto]"
                        as="h1"
                        variant="h1"
                      >
                        SFO
                ...
                <Column className="bg-gray_52 flex flex-col items-center justify-start w-[100%]">
                  ...
                  <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-center p-[16px] md:p-[8px] sm:px-[15px] sm:py-[6px] w-[100%]">
                    ...
                    <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-center justify-center ml-[16px] md:ml-[8px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[49%]">
                      ...
                      <Button
                        className="cursor-pointer font-normal min-w-[50%] ml-[16px] sm:ml-[6px] md:ml-[8px] not-italic text-[16px] text-center text-gray_51 w-[max-content]"
                        shape="RoundedBorder4"
        ...
        <Column className="absolute bg-bluegray_700_33 flex flex-col items-center justify-start left-[0] pr-[4px] py-[4px] top-[0] w-[100%]">
          <Stack className="h-[96px] max-w-[1200px] md:p-[12px] p-[24px] sm:pl-[15px] sm:pr-[15px] sm:px-[15px] sm:py-[9px] relative w-[100%]">
            <Img
          ...
          <Column className="bg-white_A700 border border-bluegray_100 border-solid flex flex-col justify-start max-w-[548px] sm:mb-[139px] md:mb-[180px] mb-[350px] mt-[179px] sm:mt-[71px] md:mt-[92px] sm:mx-[0] sm:p-[15px] md:p-[20px] p-[40px] sm:pl-[15px] sm:pr-[15px] rounded-radius12 shadow-bs w-[100%]">
            ...
            <Column className="flex flex-col items-end justify-start md:mt-[10px] mt-[20px] sm:mt-[7px] sm:pl-[15px] pl-[172px] md:pl-[88px] sm:pr-[0] w-[100%]">
              <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-center justify-end sm:px-[0] w-[100%]">
                ...
                <Button
                  className="cursor-pointer font-normal min-w-[63%] ml-[16px] sm:ml-[6px] md:ml-[8px] not-italic text-[18px] text-center text-gray_51 w-[max-content]"
                  shape="RoundedBorder4"
                  variant="FillIndigoA200"
                >
                  Upgrade for $199
