    ...
    <>
      <Column className="bg-white_A700 flex flex-col font-nunitosans items-center justify-start mx-[auto] w-[100%]">
        <Column className="flex flex-col justify-start w-[100%]">
          ...
          <Column className="flex flex-col justify-start max-w-[1840px] ml-[auto] mr-[auto] sm:mt-[15px] md:mt-[20px] mt-[40px] sm:mx-[0] sm:pl-[15px] sm:pr-[15px] sm:px-[0] w-[100%]">
            <Row className="bg-white_A700 flex flex-row md:flex-wrap sm:flex-wrap items-center md:ml-[33px] ml-[64px] sm:mx-[0] outline outline-[1px] outline-bluegray_100 rounded-radius4 shadow-bs2 sm:w-[100%] w-[48%]">
            ...
            <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-center md:ml-[33px] ml-[64px] md:mt-[12px] mt-[24px] sm:mt-[9px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[39%]">
              <SelectBox
            ...
            <Text
              className="font-semibold sm:ml-[30px] md:ml-[39px] ml-[76px] sm:mt-[19px] md:mt-[24px] mt-[48px] text-bluegray_500 w-[auto]"
              as="h2"
              variant="h2"
            >
            ...
            <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-start md:ml-[33px] ml-[64px] mt-[16px] sm:mt-[6px] md:mt-[8px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[97%]">
              <Column className="border border-indigo_50 border-solid flex flex-col items-center justify-end sm:mx-[0] pt-[16px] sm:pt-[6px] md:pt-[8px] sm:px-[15px] px-[16px] md:px-[8px] rounded-radius12 sm:w-[100%] w-[50%]">
              ...
              <Column className="flex flex-col items-end justify-start md:ml-[20px] ml-[40px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[23%]">
              ...
              <Button
                className="cursor-pointer font-normal min-w-[10%] sm:ml-[121px] md:ml-[156px] ml-[303px] sm:mt-[107px] md:mt-[138px] mt-[268px] not-italic text-[18px] text-center text-indigo_A200 w-[max-content]"
                shape="RoundedBorder4"
            ...
            <Button
              className="cursor-pointer font-normal min-w-[10%] sm:ml-[306px] md:ml-[396px] ml-[768px] md:mt-[12px] mt-[24px] sm:mt-[9px] not-italic text-[18px] text-center text-indigo_A200 w-[max-content]"
              shape="RoundedBorder4"
              variant="OutlineIndigoA200"
            >
              Show all flights
            </Button>
            <div className="md:ml-[33px] ml-[64px] sm:mt-[19px] md:mt-[24px] mt-[48px] sm:mx-[0] overflow-x-auto sm:px-[0] sm:w-[100%] w-[48%]">
            ...
            <List
              className="gap-[1px] grid min-h-[auto] sm:mt-[15px] md:mt-[20px] mt-[40px] sm:w-[100%] w-[79%]"
            ...
            <Column className="bg-white_A700 flex flex-col items-center justify-start md:ml-[123px] ml-[240px] sm:mt-[15px] md:mt-[20px] mt-[40px] sm:mx-[0] sm:py-[15px] py-[16px] md:py-[8px] sm:w-[100%] w-[79%]">
