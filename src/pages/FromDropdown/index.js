                    ...
                    <Column className="flex flex-col items-center justify-start mt-[1px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[93%]">
                      <Column className="border border-bluegray_100 border-solid flex flex-col items-center justify-start shadow-bs w-[100%]">
                        <Column className="bg-white_A700 flex flex-col items-center justify-end pt-[15px] sm:pt-[5px] md:pt-[7px] px-[15px] sm:px-[5px] md:px-[7px] w-[100%]">
                          <Text
                            className="bg-indigo_A200 font-normal mt-[1px] not-italic pl-[13px] sm:pl-[5px] md:pl-[6px] sm:pr-[15px] md:pr-[18px] pr-[35px] sm:pt-[2px] md:pt-[3px] pt-[7px] text-gray_50 w-[269px]"
                            as="h3"
                            variant="h3"
                          >
                            SFO
