...
import { Column, Row, Text, Button, Img, List, Line, Stack } from "components";
                  ...
                  <Column className="absolute flex flex-col items-center justify-start left-[0] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[87%]">
                    <Column className="flex flex-col justify-start w-[100%]">
                      ...
                      <Column className="flex flex-col items-center justify-start md:ml-[12px] ml-[24px] mt-[1px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[91%]">
                        <List
                          className="bg-white_A700 border border-bluegray_100 border-solid sm:gap-[22px] md:gap-[29px] gap-[57px] grid min-h-[auto] sm:pt-[15px] pt-[16px] md:pt-[8px] sm:px-[15px] px-[16px] md:px-[8px] shadow-bs w-[100%]"
