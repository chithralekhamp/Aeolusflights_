...
const PaymentwithDataPage = () => {
  ...
  return (
    <>
      <Column className="bg-white_A700 flex flex-col font-nunitosans items-center justify-start mx-[auto] pl-[4px] pt-[4px] w-[100%]">
        <Column className="flex flex-col items-center justify-start mt-[1px] w-[100%]">
          <header className="max-w-[1818px] ml-[auto] mr-[auto] sm:pl-[15px] sm:pr-[15px] w-[100%]">
            <Stack className="bg-white_A700 h-[93px] sm:py-[3px] md:py-[4px] py-[9px] relative w-[100%]">
              <div className="absolute inset-y-[11%] overflow-x-auto w-[100%]">
                <Stack className="h-[74px] relative w-[100%]">
                  <div className="absolute bg-white_A700 sm:h-[30px] md:h-[39px] h-[74px] w-[100%]"></div>
                  <Row className="absolute flex flex-row md:flex-wrap sm:flex-wrap h-[max-content] inset-y-[0] sm:mx-[0] my-[auto] sm:px-[0] right-[0] sm:w-[100%] w-[38%] common-row-list">
              ...
              <div className="absolute bg-white_A700 bottom-[10%] sm:h-[26px] md:h-[34px] h-[64px] w-[11%]"></div>
            </Stack>
          </header>
          <Column className="flex flex-col items-center justify-start sm:mt-[21px] md:mt-[27px] mt-[54px] w-[100%]">
            <Column className="flex flex-col justify-start max-w-[1715px] ml-[auto] mr-[auto] sm:mx-[0] sm:pl-[15px] sm:pr-[15px] sm:px-[0] w-[100%]">
              <Text
              ...
              <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-start justify-between mt-[16px] sm:mt-[6px] md:mt-[8px] w-[100%]">
                ...
                <Column className="flex flex-col items-end justify-start sm:mt-[22px] md:mt-[28px] mt-[56px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[24%]">
              ...
              <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-end justify-between mt-[10px] sm:mt-[3px] md:mt-[5px] sm:px-[0] w-[100%]">
                <Text
                ...
                <Button
                  className="cursor-pointer font-normal mb-[2px] min-w-[11%] not-italic text-[18px] text-center text-gray_51 w-[max-content]"
                  shape="RoundedBorder4"
                  variant="FillIndigoA200"
                >
                  Confirm and pay
              ...
              <Text
                className="font-normal leading-[normal] md:mt-[10px] mt-[20px] sm:mt-[7px] sm:mx-[0] not-italic text-bluegray_400 sm:w-[100%] w-[40%]"
                as="h3"
                variant="h3"
              >
              ...
              <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-start sm:mt-[11px] md:mt-[14px] mt-[28px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[18%]">
              ...
              <Input
                className="font-normal not-italic p-[0] text-[18px] placeholder:text-bluegray_800 text-bluegray_800 w-[100%]"
                wrapClassName="md:mt-[16px] mt-[31px] sm:mt-[12px] sm:mx-[0] sm:w-[100%] w-[28%]"
                type="email"
                name="email"
                placeholder="sophiaknowles89@tripma.com"
              ></Input>
              <Column className="flex flex-col items-center justify-start md:mt-[12px] mt-[24px] sm:mt-[9px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[28%]">
                <Input
                  className="font-normal not-italic p-[0] text-[18px] placeholder:text-bluegray_800 text-bluegray_800 w-[100%]"
              ...
              <Column className="flex flex-col items-center justify-start mt-[16px] sm:mt-[6px] md:mt-[8px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[29%]">
              ...
              <Text
                className="font-normal leading-[normal] mt-[16px] sm:mt-[6px] md:mt-[8px] sm:mx-[0] not-italic text-bluegray_400 sm:w-[100%] w-[40%]"
                as="h3"
                variant="h3"
              >
              ...
              <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-center md:ml-[247px] ml-[480px] sm:mt-[22px] md:mt-[28px] mt-[56px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[23%]">
                <Button
                ...
                <Button
                  className="cursor-pointer font-normal min-w-[45%] md:ml-[12px] ml-[24px] sm:ml-[9px] not-italic text-[18px] text-center text-gray_51 w-[max-content]"
                  shape="RoundedBorder4"
                  variant="FillIndigoA200"
                >
                  Confirm and pay
            ...
            <footer className="bg-white_A700 mt-[104px] sm:mt-[41px] md:mt-[53px] w-[100%]">
              <Column className="flex flex-col items-center justify-start max-w-[1916px] ml-[auto] mr-[auto] my-[16px] sm:my-[6px] md:my-[8px] sm:pl-[15px] sm:pr-[15px] w-[100%]">
                <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-start justify-between md:p-[12px] p-[24px] sm:px-[15px] sm:py-[9px] w-[100%]">
                  ...
                  <Column className="flex flex-col justify-start md:mr-[21px] mr-[42px] sm:mt-[14px] md:mt-[18px] mt-[36px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[14%]">
                ...
                <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-center justify-between mt-[17px] sm:mt-[6px] md:mt-[8px] p-[12px] sm:p-[4px] md:p-[6px] w-[100%]">
                  ...
                  <Text
                    className="font-normal mr-[104px] sm:mr-[41px] md:mr-[53px] not-italic text-bluegray_400 w-[auto]"
                    as="h2"
                    variant="h2"
                  >
