      ...
      <Column className="bg-white_A700 flex flex-col font-nunitosans items-center justify-end mx-[auto] w-[100%]">
        <Column className="flex flex-col items-center justify-end w-[100%]">
          ...
          <Column className="flex flex-col justify-start sm:mt-[15px] md:mt-[20px] mt-[40px] w-[100%]">
            <Row className="bg-white_A700 flex flex-row md:flex-wrap sm:flex-wrap items-center max-w-[872px] md:ml-[33px] ml-[auto] mr-[auto] sm:mx-[0] outline outline-[1px] outline-bluegray_100 sm:pl-[15px] sm:pr-[15px] rounded-radius4 shadow-bs2 w-[100%]">
            ...
            <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-center justify-between max-w-[1776px] md:ml-[33px] ml-[auto] mr-[auto] md:mt-[12px] mt-[24px] sm:mt-[9px] sm:mx-[0] sm:pl-[15px] sm:pr-[15px] sm:px-[0] w-[100%]">
              <Column className="flex flex-col sm:mx-[0] sm:px-[0] sm:w-[100%] w-[50%]">
                ...
                <Text
                  className="font-semibold ml-[12px] sm:ml-[4px] md:ml-[6px] sm:mt-[19px] md:mt-[24px] mt-[48px] text-bluegray_500 w-[auto]"
                  as="h2"
                  variant="h2"
                >
                ...
                <Button
                  className="cursor-pointer font-normal min-w-[20%] sm:ml-[281px] md:ml-[363px] ml-[704px] md:mt-[12px] mt-[24px] sm:mt-[9px] not-italic text-[18px] text-center text-indigo_A200 w-[max-content]"
                  shape="RoundedBorder4"
              ...
              <Column className="flex flex-col sm:mx-[0] sm:px-[0] sm:w-[100%] w-[23%]">
                <Column className="flex flex-col items-end justify-start md:mr-[3px] mr-[7px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[99%]">
                ...
                <Button
                  className="cursor-pointer font-normal min-w-[55%] ml-[185px] sm:ml-[73px] md:ml-[95px] sm:mt-[24px] md:mt-[32px] mt-[62px] not-italic text-[18px] text-center text-gray_51 w-[max-content]"
                  shape="RoundedBorder4"
                  variant="FillIndigoA200"
                >
            ...
            <div className="md:ml-[33px] ml-[64px] sm:mt-[19px] md:mt-[24px] mt-[48px] sm:mx-[0] overflow-x-auto sm:px-[0] sm:w-[100%] w-[46%]">
            ...
            <List
              className="gap-[1px] grid max-w-[1440px] min-h-[auto] ml-[auto] mr-[auto] sm:mt-[15px] md:mt-[20px] mt-[40px] sm:pl-[15px] sm:pr-[15px] w-[100%]"
