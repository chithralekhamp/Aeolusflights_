    ...
    <>
      <Column className="bg-white_A700 flex flex-col font-nunitosans items-center justify-end mx-[auto] w-[100%]">
        <Column className="flex flex-col items-center justify-end w-[100%]">
          <header className="max-w-[1847px] ml-[auto] mr-[auto] sm:pl-[15px] sm:pr-[15px] w-[100%]">
            <Stack className="bg-white_A700 h-[80px] sm:pb-[3px] md:pb-[4px] pb-[9px] relative w-[100%]">
              <Stack className="absolute h-[71px] w-[100%]">
                <div className="absolute bottom-[1%] overflow-x-auto w-[100%]">
                  <Stack className="h-[71px] relative w-[100%]">
                    <div className="absolute bg-white_A700 sm:h-[29px] md:h-[37px] h-[71px] w-[100%]"></div>
                    <Row className="absolute flex flex-row md:flex-wrap sm:flex-wrap sm:mx-[0] sm:px-[0] right-[0] top-[14%] sm:w-[100%] w-[37%] common-row-list">
          ...
          <Column className="flex flex-col items-center justify-start sm:mt-[28px] md:mt-[36px] mt-[71px] w-[100%]">
            <Column className="flex flex-col justify-start max-w-[1731px] ml-[auto] mr-[auto] sm:mx-[0] sm:pl-[15px] sm:pr-[15px] sm:px-[0] w-[100%]">
              <Text
              ...
              <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-center justify-between mt-[16px] sm:mt-[6px] md:mt-[8px] w-[100%]">
                ...
                <Column className="flex flex-col items-end sm:mx-[0] sm:px-[0] sm:w-[100%] w-[24%]">
              ...
              <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-end justify-between sm:mt-[3px] md:mt-[4px] mt-[9px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[99%]">
                ...
                <Button
                  className="cursor-pointer font-normal mb-[3px] min-w-[11%] not-italic text-[18px] text-bluegray_400 text-center w-[max-content]"
                  shape="RoundedBorder4"
              ...
              <Input
                className="font-normal not-italic p-[0] text-[18px] placeholder:text-bluegray_400 text-bluegray_400 w-[100%]"
                wrapClassName="md:mt-[12px] mt-[24px] sm:mt-[9px] sm:mx-[0] sm:w-[100%] w-[28%]"
                type="password"
                name="basetextin Five"
                placeholder="Password"
              ></Input>
              <Column className="flex flex-col items-center justify-start sm:mt-[15px] md:mt-[20px] mt-[40px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[29%]">
            ...
            <footer className="bg-white_A700 mt-[112px] sm:mt-[44px] md:mt-[57px] w-[100%]">
