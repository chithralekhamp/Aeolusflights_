        ...
        <Column className="flex flex-col items-center justify-start w-[100%]">
          ...
          <Column className="flex flex-col justify-start max-w-[1912px] ml-[auto] mr-[auto] sm:mt-[22px] md:mt-[28px] mt-[56px] sm:pl-[15px] sm:pr-[15px] sm:px-[0] w-[100%]">
              ...
              <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-start justify-between md:mt-[12px] mt-[24px] sm:mt-[9px] w-[100%]">
                <Column className="flex flex-col justify-start sm:mx-[0] sm:px-[0] sm:w-[100%] w-[55%]">
                  ...
                  <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-center sm:mt-[3px] md:mt-[4px] mt-[9px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[69%]">
                    ...
                    <Stack className="bg-gray_51 h-[32px] sm:ml-[106px] md:ml-[137px] ml-[267px] relative rounded-radius4 sm:w-[12px] md:w-[16px] w-[32px]">
                      <Img
            ...
            <footer className="bg-white_A700 sm:mt-[18px] md:mt-[24px] mt-[47px] w-[100%]">
              <Column className="flex flex-col items-center justify-start my-[16px] sm:my-[6px] md:my-[8px] w-[100%]">
