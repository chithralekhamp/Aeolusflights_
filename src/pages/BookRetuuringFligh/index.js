    ...
    <>
      <Column className="bg-white_A700 flex flex-col font-nunitosans items-center justify-start mx-[auto] w-[100%]">
        <Column className="flex flex-col items-center justify-start w-[100%]">
          <header className="max-w-[1846px] ml-[auto] mr-[auto] sm:pl-[15px] sm:pr-[15px] w-[100%]">
            <Stack className="bg-white_A700 h-[83px] sm:pb-[3px] md:pb-[4px] pb-[9px] relative w-[100%]">
              <Stack className="absolute h-[74px] w-[100%]">
                <div className="absolute bottom-[1%] overflow-x-auto w-[100%]">
                  <Stack className="h-[74px] relative w-[100%]">
                    <div className="absolute bg-white_A700 sm:h-[30px] md:h-[39px] h-[74px] w-[100%]"></div>
                    <Row className="absolute flex flex-row md:flex-wrap sm:flex-wrap h-[max-content] inset-y-[0] sm:mx-[0] my-[auto] sm:px-[0] right-[0] sm:w-[100%] w-[37%] common-row-list">
                ...
                <div className="absolute bg-white_A700 sm:h-[26px] md:h-[34px] h-[64px] w-[11%]"></div>
              </Stack>
            </Stack>
          </header>
          <Column className="flex flex-col justify-start sm:mt-[20px] md:mt-[26px] mt-[51px] w-[100%]">
            <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-start justify-between max-w-[1605px] md:ml-[67px] ml-[auto] mr-[auto] sm:mx-[0] sm:pl-[15px] sm:pr-[15px] sm:px-[0] w-[100%]">
              <Column className="flex flex-col justify-start mt-[12px] sm:mt-[4px] md:mt-[6px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[49%]">
                <Row className="bg-cyan_52 border border-solid border-teal_700 flex flex-row md:flex-wrap sm:flex-wrap items-center justify-end ml-[3px] sm:mx-[0] sm:p-[15px] p-[16px] md:p-[8px] rounded-radius8 sm:w-[100%] w-[91%]">
                  <Text
                ...
                <Text
                  className="font-bold ml-[4px] sm:mt-[16px] md:mt-[21px] mt-[41px] text-indigo_A200 w-[auto]"
                  as="h1"
                  variant="h1"
                >
                  Bon voyage, Sophia!
                ...
                <Text
                  className="font-semibold ml-[4px] sm:mt-[11px] md:mt-[14px] mt-[28px] text-bluegray_500 w-[auto]"
                  as="h2"
                  variant="h2"
                >
                ...
                <Text
                  className="font-normal leading-[normal] ml-[4px] mt-[16px] sm:mt-[6px] md:mt-[8px] sm:mx-[0] not-italic text-bluegray_400 sm:w-[100%] w-[98%]"
                  as="h2"
                  variant="h2"
                >
                ...
                <Text
                  className="font-bold ml-[12px] sm:ml-[4px] md:ml-[6px] sm:mt-[18px] md:mt-[24px] mt-[47px] text-bluegray_500 w-[auto]"
                  as="h1"
                  variant="h1"
                >
                  Flight summary
                ...
                <Row className="bg-white_A700 border border-bluegray_100 border-solid flex flex-row md:flex-wrap sm:flex-wrap items-center ml-[4px] mt-[11px] sm:mt-[4px] md:mt-[5px] sm:mx-[0] p-[4px] rounded-radius4 sm:w-[100%] w-[98%]">
                  <Img
                ...
                <Text
                  className="font-normal ml-[4px] mt-[11px] sm:mt-[4px] md:mt-[5px] not-italic text-bluegray_400 w-[auto]"
                  as="h3"
                  variant="h3"
                >
                ...
                <Text
                  className="font-semibold ml-[4px] sm:mt-[17px] md:mt-[22px] mt-[44px] text-bluegray_500 w-[auto]"
                  as="h2"
                  variant="h2"
                >
                  Arriving March 21st, 2021{" "}
                </Text>
                <Row className="bg-white_A700 border border-bluegray_100 border-solid flex flex-row md:flex-wrap sm:flex-wrap items-center ml-[4px] sm:mt-[11px] md:mt-[14px] mt-[28px] sm:mx-[0] p-[4px] rounded-radius4 sm:w-[100%] w-[98%]">
                  <Img
                    src="images/img_image25.png"
                    className="sm:h-[16px] md:h-[21px] h-[40px] max-w-[100%] ml-[12px] sm:ml-[4px] md:ml-[6px] sm:w-[15px] md:w-[20px] w-[40px]"
                ...
                <Text
                  className="font-normal mt-[16px] sm:mt-[6px] md:mt-[8px] not-italic text-bluegray_400 w-[auto]"
                  as="h3"
                  variant="h3"
                >
                ...
                <Text
                  className="font-bold ml-[4px] sm:mt-[17px] md:mt-[22px] mt-[43px] text-bluegray_500 w-[auto]"
                  as="h1"
                  variant="h1"
                >
                  Price breakdown
                </Text>
                <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-center md:ml-[17px] ml-[34px] md:mt-[11px] mt-[23px] sm:mt-[9px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[52%]">
                  <Text
                ...
                <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-center ml-[4px] mt-[18px] sm:mt-[7px] md:mt-[9px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[52%]">
                  <Text
                    className="font-normal not-italic text-bluegray_500 w-[auto]"
                    as="h2"
                    variant="h2"
                ...
                <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-center ml-[12px] md:ml-[6px] mt-[12px] sm:mt-[4px] md:mt-[6px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[52%]">
                  <Text
                    className="font-normal not-italic text-bluegray_500 w-[auto]"
                    as="h2"
                    variant="h2"
                ...
                <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-center mt-[12px] sm:mt-[4px] md:mt-[6px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[52%]">
                  <Text
                    className="font-normal not-italic text-bluegray_500 w-[auto]"
                    as="h2"
                    variant="h2"
                ...
                <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-start ml-[4px] mt-[12px] sm:mt-[4px] md:mt-[6px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[52%]">
                  <Text
                    className="font-normal not-italic text-bluegray_500 w-[auto]"
                    as="h2"
                    variant="h2"
                ...
                <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-center mt-[15px] sm:mt-[5px] md:mt-[7px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[52%]">
                  <Text
                    className="font-normal not-italic text-bluegray_500 w-[auto]"
                    as="h2"
                    variant="h2"
                ...
                <Column className="flex flex-col items-center justify-start ml-[4px] sm:mt-[3px] md:mt-[4px] mt-[9px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[52%]">
                ...
                <Text
                  className="font-bold md:ml-[10px] ml-[20px] sm:ml-[7px] sm:mt-[25px] md:mt-[33px] mt-[65px] text-bluegray_500 w-[auto]"
                  as="h1"
                  variant="h1"
                >
                  Payment method
                </Text>
                <Column className="bg-gradient4  flex flex-col items-center justify-start ml-[4px] sm:mt-[3px] md:mt-[4px] mt-[8px] sm:mx-[0] md:p-[12px] p-[24px] sm:px-[15px] sm:py-[9px] rounded-radius16 sm:w-[100%] w-[39%]">
                  <Column className="flex flex-col justify-start my-[3px] sm:px-[0] w-[100%]">
                    ...
                    />
                    <Text
                      className="font-semibold sm:mt-[22px] md:mt-[29px] mt-[57px] text-gray_50 w-[auto]"
                      as="h2"
                      variant="h2"
                    >
                      Sophia Knowles
                ...
                <Text
                  className="font-bold sm:mt-[26px] md:mt-[34px] mt-[66px] text-bluegray_500 w-[auto]"
                  as="h1"
                  variant="h1"
                >
                ...
                <Text
                  className="font-normal ml-[3px] mt-[14px] sm:mt-[5px] md:mt-[7px] not-italic text-bluegray_400 w-[auto]"
                  as="h2"
                  variant="h2"
                >
                ...
                <Input
                  ...
                  wrapClassName="md:mt-[9px] mt-[18px] sm:mt-[7px] sm:mx-[0] sm:w-[100%] w-[52%]"
                  type="email"
                  name="basetextin"
                ...
                <Input
                  className="font-normal not-italic p-[0] text-[18px] placeholder:text-bluegray_400 text-bluegray_400 w-[100%]"
                  wrapClassName="md:mt-[17px] mt-[33px] sm:mt-[13px] sm:mx-[0] sm:w-[100%] w-[52%]"
                  type="email"
                  name="basetextin One"
                  placeholder="Email address"
                ></Input>
                <Input
                  className="font-normal not-italic p-[0] text-[18px] placeholder:text-bluegray_400 text-bluegray_400 w-[100%]"
                  wrapClassName="md:mt-[12px] mt-[24px] sm:mt-[9px] sm:mx-[0] sm:w-[100%] w-[52%]"
                  type="email"
                  name="basetextin Two"
                  placeholder="Email address"
                ></Input>
                <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-start ml-[4px] sm:mt-[11px] md:mt-[14px] mt-[28px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[47%]">
                  <Button
                    className="cursor-pointer font-normal sm:mb-[1px] md:mb-[2px] mb-[5px] min-w-[44%] not-italic text-[18px] text-center text-gray_51 w-[max-content]"
                    shape="RoundedBorder4"
                    variant="FillIndigoA200"
                  >
                    Email itinerary
                  </Button>
                  <Column className="flex flex-col items-center justify-start md:ml-[37px] ml-[73px] sm:mt-[1px] md:mt-[2px] mt-[5px] sm:mx-[0] p-[11px] md:p-[5px] sm:px-[0] sm:py-[4px] rounded-radius4 sm:w-[100%] w-[37%]">
                    <Text
                ...
                <Text
                  className="font-bold ml-[3px] sm:mt-[28px] md:mt-[36px] mt-[71px] text-bluegray_500 w-[auto]"
                  as="h1"
                  variant="h1"
                >
                  Flight Route
                </Text>
                <div className="md:ml-[10px] ml-[20px] sm:mt-[30px] md:mt-[39px] mt-[76px] sm:mx-[0] overflow-x-auto sm:px-[0] sm:w-[100%] w-[98%]">
              ...
              <Column className="flex flex-col justify-start sm:mx-[0] sm:px-[0] sm:w-[100%] w-[26%]">
                ...
                <Text
                  className="font-normal leading-[normal] ml-[2px] sm:mx-[0] not-italic text-bluegray_400 sm:w-[100%] w-[97%]"
                  as="h2"
                  variant="h2"
                >
                ...
                <List
                  className="sm:gap-[18px] md:gap-[23px] gap-[46px] grid min-h-[auto] ml-[2px] sm:mt-[15px] md:mt-[19px] mt-[38px] sm:w-[100%] w-[97%]"
                ...
                <Button
                  className="cursor-pointer font-normal min-w-[40%] ml-[121px] sm:ml-[48px] md:ml-[62px] sm:mt-[11px] md:mt-[15px] mt-[30px] not-italic text-[18px] text-center text-indigo_A200 w-[max-content]"
                  shape="RoundedBorder4"
                ...
                <Text
                  className="font-bold ml-[13px] sm:ml-[5px] md:ml-[6px] sm:mt-[15px] md:mt-[19px] mt-[38px] text-bluegray_500 w-[auto]"
                  as="h1"
                  variant="h1"
                >
                  <span className="text-bluegray_500 text-[24px] font-nunitosans sm:text-[20px] md:text-[22px]">
                ...
                <Column className="flex flex-col items-center justify-start md:mt-[10px] mt-[21px] sm:mt-[8px] sm:px-[0] w-[100%]">
                  <Text
                    className="font-normal leading-[normal] sm:mx-[0] not-italic text-bluegray_400 sm:w-[100%] w-[98%]"
                    as="h2"
                    variant="h2"
                  >
                  ...
                  <Column className="bg-white_A700 flex flex-col items-center justify-start sm:mt-[26px] md:mt-[34px] mt-[66px] sm:mx-[0] rounded-radius12 shadow-bs1 sm:w-[100%] w-[98%]">
                    <Img
                ...
                <Column className="bg-white_A700 flex flex-col items-center justify-start ml-[2px] sm:mt-[12px] md:mt-[16px] mt-[32px] sm:mx-[0] rounded-radius12 shadow-bs1 sm:w-[100%] w-[97%]">
                  <Img
            ...
            <Button
              className="cursor-pointer font-normal min-w-[11%] ml-[1040px] sm:ml-[415px] md:ml-[536px] sm:mt-[15px] md:mt-[20px] mt-[40px] not-italic text-[18px] text-center text-indigo_A200 w-[max-content]"
              shape="RoundedBorder4"
              variant="OutlineIndigoA200"
            >
            ...
            <footer className="bg-white_A700 sm:mt-[3px] md:mt-[4px] mt-[8px] w-[100%]">
              <Column className="flex flex-col items-center justify-start max-w-[1920px] ml-[auto] mr-[auto] my-[16px] sm:my-[6px] md:my-[8px] sm:pl-[15px] sm:pr-[15px] w-[100%]">
                <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-start justify-between md:p-[12px] p-[24px] sm:px-[15px] sm:py-[9px] w-[100%]">
                  <Column className="flex flex-col justify-start md:ml-[49px] ml-[96px] sm:mt-[14px] md:mt-[18px] mt-[36px] sm:mx-[0] sm:pl-[0] sm:pr-[15px] pr-[16px] md:pr-[8px] py-[16px] sm:py-[6px] md:py-[8px] sm:w-[100%] w-[11%] common-column-list">
