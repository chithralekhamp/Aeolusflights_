  ...
  return (
    <>
      <Stack className="bg-white_A700 font-nunitosans h-[900px] mx-[auto] relative w-[100%]">
        <Stack className="absolute bottom-[0] h-[3817px] w-[100%]">
          <Column className="absolute flex flex-col items-center justify-start w-[100%]">
            <Column className="flex flex-col items-center justify-start w-[100%]">
              <Row className="bg-indigo_A200 flex flex-row md:flex-wrap sm:flex-wrap items-center justify-end p-[13px] sm:p-[5px] md:p-[6px] w-[100%]">
                <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-center justify-between sm:mx-[0] my-[3px] sm:px-[0] sm:w-[100%] w-[89%]">
                  <Text
                    ...
                    variant="h1"
                  >
                    Join AeolusFlights today and save up to 20% on your flight
                    using code TRAVEL at checkout. Promotion valid for new users
                    only.
                  </Text>
                  <Img
              ...
              <Column
                className="bg-cover bg-no-repeat flex flex-col items-center justify-start sm:mt-[35px] md:mt-[45px] mt-[88px] sm:p-[15px] md:p-[48px] p-[93px] w-[100%]"
          ...
          <Stack className="absolute bg-white_A700 h-[93px] inset-x-[0] mx-[auto] top-[1%] sm:w-[100%] w-[95%]">
            ...
            <Row className="absolute flex flex-row md:flex-wrap sm:flex-wrap items-center sm:mx-[0] p-[16px] md:p-[8px] sm:px-[15px] sm:py-[6px] sm:w-[100%] w-[37%]">
              ...
              <Button
                className="cursor-pointer font-normal min-w-[15%] sm:ml-[19px] md:ml-[25px] ml-[49px] sm:my-[2px] md:my-[3px] my-[6px] not-italic text-[16px] text-center text-gray_51 w-[max-content]"
                shape="RoundedBorder4"
                variant="FillIndigoA200"
              >
                Sign up
        ...
        <Column className="absolute bg-bluegray_700_33 bottom-[0] flex flex-col items-center justify-start sm:p-[15px] md:p-[49px] p-[96px] w-[100%]">
          <Column className="flex flex-col items-center justify-start max-w-[568px] sm:mb-[1174px] md:mb-[1517px] mb-[2941px] sm:mx-[0] sm:pl-[15px] sm:pr-[15px] sm:px-[0] w-[100%]">
            <Column className="bg-white_A700 border border-bluegray_100 border-solid flex flex-col items-center justify-start sm:p-[15px] md:p-[20px] p-[40px] rounded-radius12 shadow-bs w-[100%]">
              <Column className="flex flex-col items-center justify-start sm:px-[0] w-[100%]">
                ...
                <Text
                  ...
                  variant="h2"
                >
                  Aeolus Flights is totally free to use. Sign up using your
              ...
              <Button
                className="cursor-pointer font-normal min-w-[100%] mt-[12px] sm:mt-[4px] md:mt-[6px] not-italic text-[18px] text-center text-gray_51 w-[max-content]"
                shape="RoundedBorder4"
                variant="FillIndigoA200"
              >
                Create account
