    ...
    <>
      <Column className="bg-white_A700 flex flex-col font-nunitosans items-center justify-start mx-[auto] w-[100%]">
        <Column className="flex flex-col items-center justify-start w-[100%]">
          ...
          <Column className="flex flex-col justify-start max-w-[1912px] ml-[auto] mr-[auto] sm:mt-[22px] md:mt-[28px] mt-[56px] sm:pl-[15px] sm:pr-[15px] sm:px-[0] w-[100%]">
            <Column className="flex flex-col justify-start md:ml-[45px] ml-[88px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[66%]">
              <Text
              ...
              <Text
                className="font-normal leading-[normal] mt-[16px] sm:mt-[6px] md:mt-[8px] sm:mx-[0] not-italic text-bluegray_400 sm:w-[100%] w-[55%]"
                as="h2"
                variant="h2"
              >
              ...
              <Text
                className="font-semibold sm:mt-[14px] md:mt-[18px] mt-[36px] text-bluegray_500 w-[auto]"
                as="h2"
                variant="h2"
              >
                Passenger 1 (Adult)
              </Text>
              <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-center justify-between md:mt-[11px] mt-[23px] sm:mt-[9px] w-[100%]">
              ...
              <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-start justify-between md:mt-[10px] mt-[21px] sm:mt-[8px] w-[100%]">
                <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-center sm:mt-[2px] md:mt-[3px] mt-[7px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[15%]">
              ...
              <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-center sm:mt-[3px] md:mt-[4px] mt-[9px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[50%]">
                <Input
                  className="font-normal not-italic p-[0] text-[18px] placeholder:text-bluegray_800 text-bluegray_800 w-[100%]"
                  wrapClassName="sm:mx-[0] sm:w-[100%] w-[49%]"
              ...
              <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-start justify-between md:mt-[12px] mt-[24px] sm:mt-[9px] w-[100%]">
                <Column className="flex flex-col justify-start sm:mx-[0] sm:px-[0] sm:w-[100%] w-[55%]">
                  ...
                  >
                    <span className="text-bluegray_400 text-[18px] font-nunitosans">
                      ...
                      personal item. First checked bag for each passenger is
                      also free. Second bag check fees are waived for loyalty
                      program members. See the
                    </span>
                  ...
                  <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-center sm:mt-[14px] md:mt-[18px] mt-[36px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[68%]">
                    ...
                    <Text
                      className="font-semibold md:ml-[124px] ml-[242px] sm:ml-[96px] text-bluegray_400 w-[auto]"
                      as="h2"
                      variant="h2"
                    >
                      Checked bags
                  ...
                  <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-end sm:mt-[3px] md:mt-[4px] mt-[9px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[69%]">
                    <Text
                    ...
                    <Stack className="bg-gray_51 h-[32px] md:ml-[108px] ml-[210px] sm:ml-[83px] relative rounded-radius4 sm:w-[12px] md:w-[16px] w-[32px]">
                      <Img
                    ...
                    <Stack className="bg-gray_51 h-[32px] md:ml-[11px] ml-[23px] sm:ml-[9px] relative rounded-radius4 sm:w-[12px] md:w-[16px] w-[32px]">
                      <Img
                  ...
                  <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-center sm:mt-[29px] md:mt-[38px] mt-[74px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[48%]">
                    ...
                    <Button
                      className="cursor-pointer font-normal min-w-[43%] md:ml-[12px] ml-[24px] sm:ml-[9px] not-italic text-[18px] text-center text-gray_51 w-[max-content]"
                      shape="RoundedBorder4"
                      variant="FillIndigoA200"
                    >
                      Select seats
                ...
                <Column className="flex flex-col font-roboto justify-start md:mt-[11px] mt-[23px] sm:mt-[9px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[31%]">
            ...
            <footer className="bg-white_A700 sm:mt-[28px] md:mt-[36px] mt-[71px] w-[100%]">
              <Column className="flex flex-col items-center justify-start mb-[1px] mt-[16px] sm:mt-[6px] md:mt-[8px] w-[100%]">
                <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-start justify-between md:p-[12px] p-[24px] sm:px-[15px] sm:py-[9px] w-[100%]">
                  ...
                  <Column className="flex flex-col justify-start md:mr-[19px] mr-[38px] sm:mt-[14px] md:mt-[18px] mt-[36px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[14%]">
                ...
                <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-center justify-between mt-[17px] sm:mt-[6px] md:mt-[8px] p-[12px] sm:p-[4px] md:p-[6px] w-[100%]">
                  ...
                  <Text
                    className="font-normal mr-[100px] sm:mr-[39px] md:mr-[51px] not-italic text-bluegray_400 w-[auto]"
                    as="h2"
                    variant="h2"
                  >
