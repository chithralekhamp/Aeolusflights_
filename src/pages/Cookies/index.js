  ...
  return (
    <>
      <Column className="bg-white_A700 flex flex-col font-nunitosans items-center justify-end mx-[auto] w-[100%]">
        ...
        <Stack className="h-[3625px] sm:mt-[19px] md:mt-[25px] mt-[49px] relative w-[100%]">
                    ...
                    <Column className="flex flex-col items-center justify-start sm:mx-[0] sm:px-[0] sm:w-[100%] w-[89%]">
                      ...
                      >
                        <span className="text-bluegray_900 text-[18px] font-nunitosans">
                          What a great experience using Tripma! I booked all of
                          my flights for my gap year through Tripma and never
                          had any issues. When I had to cancel a flight because
                          of an emergency, Tripma support helped me{" "}
                        </span>
                        <span className="text-[18px] font-nunitosans">
                          read more...
                        </span>
                    ...
                    <Column className="flex flex-col items-center justify-start ml-[16px] md:ml-[8px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[89%]">
                      ...
                      >
                        <span className="text-bluegray_900 text-[18px] font-nunitosans">
                          ...
                          usually book our flights using other services. Tripma
                          was recommened to us by a long time friend, and I’m so
                          glad we tried it out! The process was easy and{" "}
                        </span>
                        <span className="text-[18px] font-nunitosans">
                          read more...
                        </span>
                    ...
                    <Column className="flex flex-col items-center justify-start sm:mx-[0] sm:px-[0] sm:w-[100%] w-[89%]">
                      ...
                      >
                        <span className="text-bluegray_900 text-[18px] font-nunitosans">
                          ...
                          LAX, Tripma had the best browsing experiece so I
                          figured I’d give it a try. It was my first time using
                          Tripma, but I’d definitely recommend it to a friend
                          and use it for{" "}
                        </span>
                        <span className="text-[18px] font-nunitosans">
                          read more...
          ...
          <Column
            className="absolute bg-cover bg-no-repeat flex flex-col justify-end sm:p-[15px] md:p-[20px] p-[40px] top-[0] w-[100%]"
            style={{ backgroundImage: "url('images/defaultNoData.png')" }}
          >
            <Column className="flex flex-col items-center justify-start md:ml-[4px] ml-[8px] sm:mt-[21px] md:mt-[27px] mt-[53px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[83%]">
              <Img
                src="images/img_herotextgradi.png"
                className="max-w-[100%] sm:w-[100%] w-[50%]"
                alt="HeroTextGradi"
              />
              <Row className="bg-white_A700 flex flex-row md:flex-wrap sm:flex-wrap items-center justify-end ml-[auto] sm:mt-[19px] md:mt-[24px] mt-[48px] sm:mx-[0] outline outline-[1px] outline-bluegray_100 rounded-radius4 shadow-bs sm:w-[100%] w-[80%]">
                <List
              ...
              <Column className="bg-gray_50 border border-indigo_A200 border-solid flex flex-col items-center justify-start sm:mt-[29px] md:mt-[38px] mt-[75px] sm:mx-[0] sm:p-[15px] p-[16px] md:p-[8px] rounded-radius8 sm:w-[100%] w-[20%]">
